...
case "$MODE" in
  ...
  02|03|04|05|05b|06|07)
    case "$MODE" in
      02) run_step "CLUSTER/02_compute_tissue_qc.py" ;;
      03) run_step "CLUSTER/03_fit_prototypes.py" ;;
      04) run_step "CLUSTER/04_assign_prototypes.py" ;;
      05) run_step "CLUSTER/05_cluster_prototypes.py" ;;
